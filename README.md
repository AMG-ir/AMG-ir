...
**Computer Engineering Student | Networking · Linux · Windows Server · Python**

I'm a Computer Engineering student building my skills in **networking, Linux & Windows administration, virtualization, and cybersecurity** through hands-on labs and personal projects.

Currently focused on strengthening my foundations in **network infrastructure, Linux systems, server administration, and automation with Python**.
...
![Network+](https://img.shields.io/badge/CompTIA-Network%2B-CC2927?style=flat-square)
...
* 🖥️ Virtualization with VMware and KVM
* 🐍 Python scripting and automation
* 🔐 Learning system and network security
* 🤖 Building small automation tools and Telegram bots
...
**Networking → Linux → Windows Server → Virtualization → Cybersecurity**

I'm building my knowledge through courses, labs, personal projects, and hands-on experimentation.
